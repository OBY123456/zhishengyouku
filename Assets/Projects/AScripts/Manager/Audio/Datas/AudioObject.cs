...
namespace MTFrame.MTAudio
{
    ...
    public class AudioObject : MonoBehaviour
    {
        ...
        /// 音频名字
        /// </summary>
        public string AudioName{ get { return audioName; } private set { audioName = value; } }
        /// <summary>
        /// 声音是否正在播放
        /// </summary>
        ...
        public void init(AudioClip audio, AudioParamete audioParamete,string _audioName)
        {
            this.clip = audio;
